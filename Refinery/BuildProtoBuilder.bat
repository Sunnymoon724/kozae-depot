...
"%PY%" -m PyInstaller --noconfirm --clean --onefile --name KZProtoBuilder --paths Source --hidden-import openpyxl --hidden-import msgpack --collect-submodules KZProtoBuilder --collect-all openpyxl --collect-all msgpack --collect-data KZProtoBuilder kz_proto_builder_cli.py
if errorlevel 1 (
